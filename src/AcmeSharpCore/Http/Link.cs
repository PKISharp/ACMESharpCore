...
namespace AcmeSharpCore.Http
{
    /// <summary>
    /// Represents a Link header value that corresponds to the well-defined HTTP response
    /// entity header <see
    /// cref="https://en.wikipedia.org/wiki/List_of_HTTP_header_fields#Response_fields"
    /// ><c>Link</c></see> and more fully specified in <see
    /// cref="https://tools.ietf.org/html/rfc5988#section-5">RFC 5988 Section 5</see>.
    /// </summary>
    /// <remarks>
