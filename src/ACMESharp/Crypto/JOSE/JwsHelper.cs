...
namespace ACMESharp.Crypto.JOSE
{
    ...
    public static class JwsHelper
    {
        ...
        /// </summary>
        public static byte[] ComputeThumbprint(JwsTool signer, HashAlgorithm algor)
        {
        ...
        /// </summary>
        public static string ComputeKeyAuthorization(JwsTool signer, string token)
        {
        ...
        /// responses.
        /// </summary>
        public static string ComputeKeyAuthorizationDigest(JwsTool signer, string token)
        {
            using (var sha = SHA256.Create())
            {
                var jwkThumb = CryptoHelper.Base64.UrlEncode(ComputeThumbprint(signer, sha));
