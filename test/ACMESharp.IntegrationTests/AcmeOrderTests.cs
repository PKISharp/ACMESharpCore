        ...
        IClassFixture<AwsFixture>
    {
        ...
        public async Task InitAcmeClient()
        {
            ...
            if (acct == null || keys == null)
            {
                ...
                Clients.Acme = new AcmeProtocolClient(Clients.Http, new Crypto.JOSE.JwsAlgorithmFactory().Create("ES256"));
            ...
            else
            {
                ...
                var signer = new Crypto.JOSE.JwsAlgorithmFactory().Create(keys);
